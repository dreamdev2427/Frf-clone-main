  ...
  return (
    <div className="volts">
      <section className="main-page">
        ...
        <section className="volts-section">
              ...
              <div className="col-sm-6 col-lg-4 column">
                <div className="voltcard" id="volt1">
                  ...
                  <div className="card-body">
                    ...
                    <div className="claim">
                      <div className="claimable-amount zero">0.00000</div>
                  ...
                  <div className="card-goto-explore-nochildren">
                    <div className="caption">
                      Details
                      <img src="/images/downminarrow.svg" alt="downarrow"></img>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 col-lg-4 column">
                <div className="voltcard" id="volt2">
                  ...
                  <div className="card-goto-explore">
                    <div className="caption">
                      Hide
                      <img src="/images/upminarrow.svg" alt="uparrow"></img>
                    </div>
